...
link="/Users/phoebemeister/Julia_MC/ParallelTemperingMonteCarlo.jl/scripts/look-up_table_he_correct.txt"
...
#use same for helium
pos_ne96_fcc = [[ 1.56624152, 0.90426996, 0. ],
...
pos_ne96_hcp=[[ 1.56624152, 0.90426996, 0.0],
...
[ 7.8312076, 0.90426996, 5.11532339],
...
[ 7.8312076, 6.32988974, 5.11532339],
...
[ 15.6624152, 9.04269963, 5.11532339],

[ 0.0, 1.80853993, 7.67298508],
...
[ 7.8312076, 4.52134982, 7.67298508],
...
[ 9.39744912, 7.23415971]]

pos_he96 = pos_ne96_fcc * AtoBohr

#binding sphere
box_length = 12.52993216 * AtoBohr
box_height = 15.34597014 * AtoBohr
#CubicBC (only box_length) -> RhombicBC (also box_height)
bc_he96 = RhombicBC(box_length, box_height)   

length(pos_he96) == n_atoms || error("number of atoms and positions not the same - check starting config")

start_config_1 = Config(pos_he96, bc_he96)
start_config_2 = Config(pos_he96, bc_he96)
